...
```{r eval=FALSE, include=TRUE}
# Crawling data
crawling.keyword <- search_tweets(keyword, n = jumlahtweet, include_rts = retweet)

# Melihat hasil crawling
View(crawling.keyword)
```
...
write_as_csv(crawling.keyword, here("data", "temporary", "hasil-crawling_keyword.csv"), 
